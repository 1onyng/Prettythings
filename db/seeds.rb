...
file = open('https://pretty-things-seeds.s3-us-west-1.amazonaws.com/demo_user_avatar.jpeg')
demo_user.profile_photo.attach(io: file, filename: "demo_user_avatar.jpeg")
demo_user.save!
# until photos.empty?
#   photo = photos.shift
